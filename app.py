    ...
    [
        dbc.Col(
            [
                ...
                dbc.Spinner(dcc.Graph(id='graph_3')),
                dbc.Spinner(dcc.Graph(id='graph_4')),
                dbc.Spinner(dcc.Graph(id='graph_5')),
                dbc.Spinner(dcc.Graph(id='graph_6')),
                dbc.Spinner(dcc.Graph(id='graph_7')),
                html.Br(),
                tabs,
                html.Br(),
                submit_button
...
def analyse_beam(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_1):
    try:
...
def analyse_beam_2(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_2):
    try:
        t1 = time.perf_counter()
        ...
        graph_2 = beam.plot_reaction_force()
...
def analyse_beam_3(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_3):
    try:
        t1 = time.perf_counter()
...
def analyse_beam_4(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_4):
    try:
        t1 = time.perf_counter()
        ...
        graph_4 = beam.plot_bending_moment()
...
def analyse_beam_5(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_5):
    try:
        t1 = time.perf_counter()
...
def analyse_beam_6(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_6):
    t1 = time.perf_counter()
    ...
    graph_6 = beam.plot_beam_internal()
...
def analyse_beam_6(click, beams, point_loads, point_torques, querys,
                 distributed_loads, supports, graph_7):
    t1 = time.perf_counter()
    ...
    graph_7 = beam.plot_beam_external()
